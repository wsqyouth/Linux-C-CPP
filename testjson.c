...
make
make install
gcc -o testjson -g testjson.c -std=c99 -I /usr/local/include/  -L /usr/local/lib/ -ljson-c
#简化版
vi /etc/ld.so.conf加入include /usr/local/lib/后
简化为：
gcc -o testjson  testjson.c   -ljson-c
